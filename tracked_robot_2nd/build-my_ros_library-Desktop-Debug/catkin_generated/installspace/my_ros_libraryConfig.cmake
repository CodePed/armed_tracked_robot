...
if(my_ros_library_CONFIG_INCLUDED)
  return()
endif()
set(my_ros_library_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("FALSE" STREQUAL "TRUE")
  set(my_ros_library_SOURCE_PREFIX /home/cirlab/catkin_ws/src/tracked_robot_2nd/my_ros_library)
  set(my_ros_library_DEVEL_PREFIX /home/cirlab/catkin_ws/devel)
  set(my_ros_library_INSTALL_PREFIX "")
  set(my_ros_library_PREFIX ${my_ros_library_DEVEL_PREFIX})
else()
  set(my_ros_library_SOURCE_PREFIX "")
  set(my_ros_library_DEVEL_PREFIX "")
  set(my_ros_library_INSTALL_PREFIX =/home/cirlab/catkin_ws/install)
  set(my_ros_library_PREFIX ${my_ros_library_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'my_ros_library' is deprecated")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND my_ros_library_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path =/home/cirlab/catkin_ws/install/lib;/home/cirlab/catkin_ws/devel/lib;/opt/ros/kinetic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(my_ros_library_LIBRARY_DIRS ${lib_path})
      list(APPEND my_ros_library_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'my_ros_library'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND my_ros_library_LIBRARIES ${lib})
    endif()
  endif()
...
set(my_ros_library_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${my_ros_library_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()

set(depends "roscpp;rospy;std_msgs;actionlib;actionlib_msgs;message_generation;my_ros_action")
foreach(depend ${depends})
  string(REPLACE " " ";" depend_list ${depend})
  # the package name of the dependency must be kept in a unique variable so that it is not overwritten in recursive calls
  list(GET depend_list 0 my_ros_library_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${my_ros_library_dep}_FOUND)
      find_package(${my_ros_library_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${my_ros_library_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(my_ros_library_INCLUDE_DIRS ${${my_ros_library_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(my_ros_library_LIBRARIES ${my_ros_library_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${my_ros_library_dep}_LIBRARIES})
  _list_append_deduplicate(my_ros_library_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(my_ros_library_LIBRARIES ${my_ros_library_LIBRARIES})

  _list_append_unique(my_ros_library_LIBRARY_DIRS ${${my_ros_library_dep}_LIBRARY_DIRS})
  list(APPEND my_ros_library_EXPORTED_TARGETS ${${my_ros_library_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${my_ros_library_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
